...
<div class="container d-flex flex-column justify-content-between vh-100">
                ...
                <div class="card-header bg-primary">
                    <div class="app-brand">
                        <a href="/index.html">
                            ...
                            <span class="brand-name">Webcoder Partha</span>
                        </a>
                    </div>
                </div>
    ...
    <div class="copyright pl-0">
        <p class="text-center">&copy; 2021 Webcoderpartha
            <a class="text-primary" href="http://www.webcoderpartha.com/" target="_blank">Webcoder Partha</a>.
        </p>
    </div>
</div>
</body>
